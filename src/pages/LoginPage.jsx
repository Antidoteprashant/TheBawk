...
const LoginPage = () => {
    ...
    return (
        <section className="login-page" ref={container} style={{
            minHeight: '100vh',
            display: 'flex',
            ...
            <form className="form" onSubmit={handleSubmit}>
                ...
                <div className="flex-row">
                    ...
                    <span className="span" onClick={() => alert("Forgot Password logic coming soon!")}>Forgot password?</span>
                </div>
                ...
                <div className="flex-row">
                    <button type="button" className="btn google" onClick={() => handleSocialLogin('google')} disabled={loading}>
                        <svg
                            xmlSpace="preserve"
                    ...
                    <button type="button" className="btn apple" onClick={() => handleSocialLogin('apple')} disabled={loading}>
                        <svg
                            xmlSpace="preserve"
